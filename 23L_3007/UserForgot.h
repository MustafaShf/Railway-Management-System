...
namespace OOPProjectGUI {
	...
	/// <summary>
	/// Summary for UserForgot
	/// </summary>
	public ref class UserForgot : public System::Windows::Forms::Form
	{
	public:
		UserForgot(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(UserForgot::typeid));
			...
			this->label2->Location = System::Drawing::Point(81, 249);
			...
			this->textBox1->Location = System::Drawing::Point(311, 305);
			...
			this->label4->Location = System::Drawing::Point(191, 305);
			...
			this->button1->Location = System::Drawing::Point(248, 386);
			...
			this->button3->Location = System::Drawing::Point(375, 386);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(75, 33);
			this->button3->TabIndex = 25;
			this->button3->Text = L"EXIT";
			this->button3->UseVisualStyleBackColor = false;
			this->button3->Click += gcnew System::EventHandler(this, &UserForgot::button3_Click);
			// 
			// UserForgot
			// 
			...
			this->Name = L"UserForgot";
			this->Text = L"UserForgot";
...
#pragma endregion
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		if (MessageBox::Show("Do you want to exit User Forgot?", "ExitPrompt", MessageBoxButtons::YesNo, MessageBoxIcon::Warning) == System::Windows::Forms::DialogResult::Yes)
			UserForgot::Close();
	}
};
}
